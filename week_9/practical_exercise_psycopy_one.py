...
def demonstrate_mario_game(screen_index=0):
    ...
    try:
        ...
        exp_info['images'] = [
            './week_9/assets/Goomba.png', './week_9/assets/Lakitu.png', 
            './week_9/assets/Bill.png', './week_9/assets/SuperHammer.png'
        ]
...
if __name__ == "__main__":
    ...
    demonstrate_mario_game(screen_index) 